...
LaunchkeyMk3::~LaunchkeyMk3 ()
{
	...
	/* stop event loop */
	DEBUG_TRACE (DEBUG::LaunchkeyMk3, "BaseUI::quit ()\n");
...
*/
	...
	DEBUG_TRACE (DEBUG::LaunchkeyMk3, string_compose("LaunchkeyMk3::set_active done with yn: '%1'\n", yn));
...
*/
std::string
LaunchkeyMk3::input_port_name () const
{
#ifdef __APPLE__
...
#else
	return X_("LaunchkeyMk3 DAW 1 (in)");
#endif
}

std::string
LaunchkeyMk3::output_port_name () const
{
#ifdef __APPLE__
	/* the origin of the numeric magic identifiers is known only to Ableton
	   and may change in time. This is part of how CoreMIDI works.
...
#else
	return X_("LaunchkeyMk3 DAW 1 (out)");
#endif
}
